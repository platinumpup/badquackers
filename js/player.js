...
class Player {
    ...
    createBoostParticles() {
        ...
        for (
            ...
            this.exhaustParticles.push({
                ...
                x:
                    Config.PLAYER.JET_OFFSET_X,

                y:
                    Config.PLAYER.JET_OFFSET_Y +
                    (
                        Math.random() -
                        0.5
                    ) * 6,
    ...
    updateExhaust(deltaTime) {
        ...
        for (
            let i =
                this.exhaustParticles.length - 1;
    ...
    drawExhaust(ctx) {
        ...
        glow.addColorStop(
            ...
            boosting
                ...
                : "rgba(140, 194, 255, 0.65)"
        );

        glow.addColorStop(
            0.35,
            "rgba(45, 143, 255, 0.45)"
        );
        ...
        flameGradient.addColorStop(
            0.18,
            "rgba(125, 240, 255, 0.98)"
        );

        flameGradient.addColorStop(
            0.48,
            "rgba(35, 112, 255, 0.88)"
        );
        ...
        if (boosting) {
            ...
            coreGradient.addColorStop(
                0.30,
                "rgba(200, 242, 255, 0.98)"
            );

            coreGradient.addColorStop(
                0.70,
                "rgba(90, 217, 255, 0.72)"
            );
